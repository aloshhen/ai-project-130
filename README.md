...
- React (для гибкости и переиспользуемости компонентов)  
- Next.js (для SSR/SSG и оптимизации под разные платформы)  
- Tailwind CSS (для быстрого создания адаптивного дизайна)  
- Framer Motion (для плавных анимаций и эффектов)  
- Telegram WebApp SDK (для интеграции с Telegram Mini App)
